class SingleAppointmentDetails {
  Data data;

  SingleAppointmentDetails({this.data});

  SingleAppointmentDetails.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Salon salon;
  Null address;
  List<Null> specialities;

  Data({this.id, this.appointmentDate, this.appointmentTime, this.day, this.description, this.applicant, this.barber, this.salon, this.address, this.specialities});
...
//      specialities = new List<Null>();
//      json['specialities'].forEach((v) { specialities.add(new Null.fromJson(v)); });
//    }
  }
...
class Barber {
  ...
  Barber({this.id, this.name, this.image, this.email, this.phone,
    this.type, this.fees, this.services, this.salons, this.experience, this.availability, this.specifications, this.ratings});
...
//      json['services'].forEach((v) { services.add(new Null.fromJson(v)); });
//    }
//    if (json['salons'] != null) {
//      salons = new List<Null>();
//      json['salons'].forEach((v) { salons.add(new Null.fromJson(v)); });
//    }
//    experience = json['experience'];
//    if (json['availability'] != null) {
//      availability = new List<Null>();
//      json['availability'].forEach((v) { availability.add(new Null.fromJson(v)); });
//    }
//    if (json['specifications'] != null) {
//      specifications = new List<Null>();
//      json['specifications'].forEach((v) { specifications.add(new Null.fromJson(v)); });
//    }
...
//      json['specialities'].forEach((v) { specialities.add(new Specialities.fromJson(v)); });
//    }
  }
