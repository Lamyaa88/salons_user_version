...
boldTitleRow({BuildContext context, String text , Function onTapViewMore ,
  bool withViewMore : true
  , Color textColor : textColor , FontWeight fontWeight : FontWeight.normal
  , double heightPercentage : .025}) {
