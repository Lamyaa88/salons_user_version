                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              ...
                              Row(
                                children: [
                                  customDescriptionTextText(
                                      ...
                                      context,
                                      text:
                                      checkDirection(cubit.singleBarberMap["data"]["name"],
                                        cubit.singleBarberMap["data"]["name"],) ,
                                      maxLines:
                                      10,
                                      textAlign:
                                      TextAlign
                              ...
                              Container(height: height*.2,child:
                              ListView.builder(
//                                              shrinkWrap: true,
                                  physics:
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                                child: customDescriptionTextText(
                                                                    ...
                                                                    TextAlign
                                                                        .start,
                                                                    text:checkDirection(cubit.singleBarberMap["data"]["services"][subIndex]["name_ar"]
                              ...
                              CustomButton(text: "Book Appointment with",
                                onTapButton: (){
                                  customAnimatedPushNavigation(context,
                                      BookAppointmentScreen(barberId:cubit.singleBarberMap["data"]["id"].toString() ,
