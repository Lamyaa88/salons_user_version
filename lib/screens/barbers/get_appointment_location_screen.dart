...
//class PickAppointmentLocationScreen extends StatefulWidget {
//  final double lat ;
//  final double long ;
//
//  PickAppointmentLocationScreen(this.lat , this.long);
//  @override
//  _PickAppointmentLocationScreenState createState() => _PickAppointmentLocationScreenState(lat ,long);
//}
//class _PickAppointmentLocationScreenState extends State<PickAppointmentLocationScreen> {
//  final double lat ;
//  final double long ;
//
//  double orderLat ;
//  double orderLong ;
//  _PickAppointmentLocationScreenState(this.lat, this.long);
//
//
//  //--------------------------------------
//
...
//            BookAppointmentScreen(appointmentPlace: userPickedLocation,));
//
//      } , alertTitle:
//      translator.translate("Barber will visit you in this location ") , alertSubtitle: "${userPickedLocation} "
...
//                customDescriptionTextText(context: context, text: alertTitle , fontWeight:
//                FontWeight.bold , textColor: blackColor , percentageOfHeight: .025 , maxLines: 2),
//                responsiveSizedBox(context: context, percentageOfHeight: .02),
...
//                    GestureDetector(
//                        child:
//                        customDescriptionTextText(context: context, text: translator.translate("Continue") ,
//
//                            textColor: blueColor
