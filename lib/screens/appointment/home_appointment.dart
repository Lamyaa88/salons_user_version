...
class AppointmentsHomeScreen extends StatefulWidget {
  @override
  _AppointmentsHomeScreenState createState() =>
      _AppointmentsHomeScreenState();
}
                  ...
                  builder: (context, state) {
                    ...
                    if (state is! BarberAppointmentsLoadingState) {
                      return Container(
                        ...
                        cubit.barberAppointmentsMap["data"].length ==
                            0 ? Column(children: [
                              responsiveSizedBox(context: context , percentageOfHeight: .1),
                              Image.asset(AppImages.no_appointments_yet),
                          customDescriptionTextText(context: context , text: "you dont have any appointments yet ")
                        ],):
                        Container(
                          height: height,
                          child:  Container(
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        ...
                                                                        customDescriptionTextText(
                                                                            ...
                                                                            TextAlign
                                                                                .start,
                                                                            text: "${cubit.barberAppointmentsMap["data"][index]["barber"]["name"].toString()}"),
