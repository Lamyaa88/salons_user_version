...
class AllSalonSpecifications extends StatelessWidget {
  @override
                ...
                Container(
                  ...
                  child: NetworkIndicator(
                    ...
                    create: (BuildContext context) =>
                        AllSpecificationsCubit()..getAllSpecifications(),
                    child: ListView(
//                    physics: BouncingScrollPhysics(),
                      children: <Widget>[
                        Container(
                          child: BlocConsumer<AllSpecificationsCubit,
                              AllSpecificationsStates>(
                            ...
                            builder: (context, state) {
                              ...
                              if (state is! AllSpecificationsLoadingState) {
                                return Container(
                                  ...
                                  width: width * .9,
                                  child: Container(
                                    child: cubit.allSpecificationsModel.data
                                                .length ==
                                            0
                                        ? customDescriptionTextText(
                                            context: context,
                                                        ...
                                                        decoration:
                                                            BoxDecoration(
                                                                image:
                                                                    DecorationImage(
                                                                  image: NetworkImage(
                                                                      "${baseImageUrl}${cubit.allSpecificationsModel.data[index].image}"),
                                                                  fit: BoxFit
                                                                      .cover,
                                                                ),
